    ...
    return (
        <div className="space-y-6 pb-20">
            ...
            <div className="bg-gray-800 p-4 rounded-xl space-y-4">
                <h3 className="text-lg font-bold text-[#CA8A04] mb-2">Your Figures</h3>
                <div>
                    ...
                    <input
                        ...
                        className="w-full p-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-[#CA8A04] focus:border-[#CA8A04]"
                    />
                </div>
                ...
                <div className="flex items-center gap-3 pt-2">
                    <input
                        ...
                        className="h-5 w-5 rounded bg-gray-700 border-gray-600 text-[#CA8A04] focus:ring-[#CA8A04]"
                    />
            ...
            <div className="bg-gray-800 p-4 rounded-xl">
                <h3 className="text-lg font-bold text-[#CA8A04] mb-4">Estimated Take-Home</h3>

                <div className="mb-4 p-4 bg-gray-700/50 rounded-xl border border-[#CA8A04]/30 text-center">
                    <span className="text-xs font-medium text-[#CA8A04]">Annual Net Income</span>
