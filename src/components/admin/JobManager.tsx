            ...
            <div className="flex flex-col md:flex-row justify-between gap-4 bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                <div className="relative flex-1">
                    ...
                    <input 
                        ...
                        className="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#CA8A04] focus:border-transparent outline-none"
                    />
                </div>
                ...
                <button 
                    ...
                    className="flex items-center gap-2 bg-[#CA8A04] text-white px-4 py-2 rounded-lg hover:bg-[#854D0E] transition-colors shadow-sm font-medium"
                >
